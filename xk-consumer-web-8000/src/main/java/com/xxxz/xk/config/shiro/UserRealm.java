...
//        User dbUser = userServiceFeign.loginByPhone(phone);
...
//                ResponseDTO add = userServiceFeign.add(dbUser);
...
//            ResponseDTO res = userServiceFeign.findUserRolesByPhone(dbUser.getRoles());
...
//        Set<String> roles = userServiceFeign.findRolesByPhone(phone);
//        auth.setRoles(roles);
//        Set<String> permissions = userServiceFeign.findPermissionsByPhone(phone);
...
//        User user = userServiceFeign.selectUserSimpleInfo(userId);
